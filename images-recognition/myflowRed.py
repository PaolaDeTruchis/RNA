...
model = Sequential()        
model.add(Dense(196, activation='sigmoid', input_shape=(784,))) # creation of the first layer
model.add(Dense(98, activation='sigmoid'))                     # creation of the second layer
model.add(Dense(50, activation='sigmoid'))                      # creation of the third layer
model.add(Dense(30, activation='sigmoid'))                      # creation of the fourth layer
