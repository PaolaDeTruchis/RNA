...
model.add(Dense(300, activation='sigmoid'))                    # creation of the second layer 
model.add(Dense(100, activation='sigmoid'))                    # creation of the third layer
model.add(Dense(50, activation='sigmoid'))                     # creation of the fourth layer
